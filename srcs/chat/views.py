...
def chat_view(request):
    ...
    return render(request, 'chat/chat.html', {
        ...
        'users': users,
        'blocked_by_users': blocked_by_users  # Ajouter cette nouvelle variable au contexte
    })
    ...
    if request.method == 'POST':
        ...
        try:
            ...
            Message.objects.create(
                ...
                recipient=recipient,
                content=content,
                is_game_invite=False  # Spécifier explicitement que c'est un message normal
            )
...
#     return JsonResponse({'status': 'success', 'game_url': '/game/'})
